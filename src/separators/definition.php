...
if (!defined('NESTING_SEPARATOR')) {
     ...
     *
     * Допускається використовувати знак більше '>' або крапку '.' як в інших фреймворках.
     *
     * ВАЖЛИВО! Щоб встановити власне значення для цієї константи - потрібно визначити її ДО підключення файлу vendor/autoload.php що містить автозавантажувач від Composer.
     */
...
if (!defined('BACKWARD_NESTING_SEPARATOR')) {
     ...
     * що використовується при побудові шляхів без використання стандартного роздільника каталогів, а також для масивів та інших структур що мають вкладеність.
     *
     * Допускається використовувати знак більше '<' або стрілочку вверх '^' (карет).
     *
     * ВАЖЛИВО! Щоб встановити власне значення для цієї константи - потрібно визначити її ДО підключення файлу vendor/autoload.php що містить автозавантажувач від Composer.
     */
